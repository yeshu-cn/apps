...
import { FOOTBALL_ISLAND, coastPoint, islandTerrain } from './island-layout.js?v=football-20260923';
...
export function createFootballIsland({ sand, sandMap, wood, palm }) {
    ...
    for (const [px, pz, height, lean] of [[x - 8, z - 8.8, 4.8, -.25], [x + 7.3, z - 9.3, 5.1, .3], [x + 13.5, z - 4, 4.2, .2]]) palm(px, pz, height, lean);
