import { RESIDENT_MODELS } from './room-resident.js?v=dialog-default-20260923';
...
export function createCharacterPicker({ stage, getCurrent, select }) {
    ...
    dialog.innerHTML = `<div class="panel-inner"><button class="panel-close" type="button" aria-label="关闭人物选择"><img src="assets/vendor/bootstrap-icons/x.svg" alt="" width="23" height="23"></button><p class="panel-kicker">小岛上的你</p><h2 id="character-title" tabindex="-1" autofocus>选一位同行的人。</h2><p class="character-intro">换个模样，继续在小岛上走走。</p><div class="character-options"></div><p class="character-status" role="status" aria-live="polite"></p><button type="button" class="character-done">去小岛走走</button></div>`;
