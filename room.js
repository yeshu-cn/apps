...
import('./room-scene.js?v=football-20260923').then(({ startRoomScene }) => startRoomScene({ stage, canvas: document.getElementById('room-canvas'), links, onSelect: openApp, onBrowse: () => { setBrowse(true, shelfButton); document.getElementById('close-objects').focus({ preventScroll: true }); } })).catch(error => {
