...
import('./room-scene.js?v=snowboarder-20260922').then(({ startRoomScene }) => startRoomScene({ stage, canvas: document.getElementById('room-canvas'), links, onSelect: openApp })).catch(error => {
